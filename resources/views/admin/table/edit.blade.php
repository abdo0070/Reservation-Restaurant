              ...
              <div class="shadow sm:overflow-hidden sm:rounded-md">
                <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                      ...
                      <div class="mt-1 flex rounded-md shadow-sm">
                        <input type="text" name="name" value="{{$table->name}}" id="name" class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm   @error('name') border-red-400 @enderror" placeholder="">
                      </div>
                      @error('name')
                      ...
                      <div class="mt-1 flex rounded-md shadow-sm">
                        <input type="number" name="guest_number" value="{{$table->guest_number}}" id="name" class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('guest_number') border-red-400 @enderror">
                      </div>
                      @error('guest_number')
                      <div class="text-red-400" >{{ $message }}</div>
                    @enderror
                      ...
                      <div class="mt-1 flex rounded-md shadow-sm">
                        <input type="text" name="location"  value="{{$table->location}}" id="name" class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('location') border-red-400 @enderror">
                      </div>
                      @error('location')
                      <div class="text-red-400" >{{ $message }}</div>
                    @enderror
